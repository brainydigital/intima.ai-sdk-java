...
public class EscutasApi {
    ...
    public EscutasApi(ApiClient apiClient) {
    ...
    /**
     * Build call for createProcessEscuta
     ...
     */
    public com.squareup.okhttp.Call createProcessEscutaCall(String processo, Integer pjeAuthId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/actions/process-docs/{pje_auth_id}"
    ...
    /**
     * Realiza uma nova escuta processual (asynchronously)
     * 
     * @param processo  (required)
     * @param pjeAuthId é o id referente ao tribunal cadastrado em \&quot;Tribunais ativos\&quot; no Intima.ai (required)
     ...
     */
    public com.squareup.okhttp.Call createProcessEscutaAsync(String processo, Integer pjeAuthId, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createProcessEscutaValidateBeforeCall(processo, pjeAuthId, progressListener, progressRequestListener);
