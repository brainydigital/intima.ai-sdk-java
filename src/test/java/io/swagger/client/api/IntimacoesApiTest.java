...
/**
 * API tests for IntimacoesApi
 */
@Ignore
public class IntimacoesApiTest {

    private final IntimacoesApi api = new IntimacoesApi();
     ...
     */
    @Test
    public void getAllIntimacoesTest() throws ApiException {
        api.getAllIntimacoes();
